        ...
        <div className="flex items-center gap-4">
          ...
          <div className="relative flex-shrink-0">
            ...
            <button
              ...
              className="absolute -bottom-1 -right-1 min-w-[44px] min-h-[44px] w-11 h-11 text-white rounded-full flex items-center justify-center shadow-md disabled:opacity-50"
          ...
          <div className="flex gap-2">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full pl-8 pr-3 py-2 min-h-[44px] text-base border border-gray-200 rounded-lg focus:ring-1 focus:ring-gray-300 focus:border-gray-300 outline-none"
                style={{ fontSize: '16px' }}
              />
            </div>
            <button
              ...
              disabled={saving}
              className="px-4 py-2 min-h-[44px] rounded-lg text-white text-xs font-semibold disabled:opacity-50 flex items-center gap-1.5"
              style={{ background: 'linear-gradient(135deg, #FF8C42, #E85D26)' }}
            >
